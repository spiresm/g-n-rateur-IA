  ...
  return (
    <>
      ...
      <div className="pt-20">
        ...
        <div className="flex flex-col md:flex-row" style={{ minHeight: "calc(100vh - 80px)", background: "#0b0b0b" }}>
          <div className="w-full md:w-1/2 border-r" style={{ background: "#131313", borderColor: "#2a2a2a" }}>
            {workflow === 'poster' ? (
              <PosterGenerator 
          ...
          <div className="w-full md:w-1/2" style={{ background: '#181818' }}>
            <PreviewPanel
              ...
              imageDimensions={imageDimensions as any}
              onChangeFormat={(dims) => setImageDimensions(dims)}
              onStartGeneration={() => {
