...
export const Header = memo(function Header() {
  ...
  // ✅ Supabase stocke l'image Google ici (avatar_url)
    ...
    <header className="fixed top-0 left-0 right-0 h-32 bg-gray-900 border-b border-gray-800 flex items-center justify-between px-6 z-50">
      <div className="flex items-center gap-4">
        ...
        <div className="flex flex-col">
          <h1 className="text-3xl text-white font-bold tracking-tight">RUBENS <span className="text-purple-500">AI</span></h1>
      ...
      {isAuthenticated && user && (
        <div className="flex items-center gap-6">
          <QuotaDisplay onUpgradeClick={() => {}} />

          <div className="flex items-center gap-4 pl-6 border-l border-gray-700">
            <div className="text-right hidden sm:block">
              <p className="text-xs text-gray-500 uppercase font-bold">Connecté</p>
