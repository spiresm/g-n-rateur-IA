        ...
        {isAuthenticated && user && (
          <div className="flex items-center gap-3 sm:gap-6 ml-auto">
            ...
            >
              ...
              <span className="hidden md:inline font-bold text-xs uppercase tracking-tighter">Premium</span>
            </button>

            {/* Bloc Utilisateur avec petit rond */}
            <div className="flex items-center gap-3 pl-3 border-l border-gray-700">
              <div className="hidden lg:flex flex-col items-end">
                <span className="text-[9px] text-gray-500 uppercase font-black">Utilisateur</span>
                <span className="text-xs text-gray-300 font-medium max-w-[120px] truncate">{user.email}</span>
              </div>
